...
export const partnerExperiences = [
  ...
  },
  {
    ...
    category: 'experiences' as const,
    description: {
      pt: ['Experiência de kayak transparente', 'Aluguer de kayaks', 'Tours personalizadas'],
      en: ['Clear kayak experience', 'Kayak rental', 'Personalized tours'],
      fr: ['Expérience de kayak transparent', 'Location de kayaks', 'Tours personnalisés'],
      es: ['Experiencia de kayak transparente', 'Alquiler de kayaks', 'Tours personalizados'],
