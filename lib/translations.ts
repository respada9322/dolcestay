...
export const translations = {
  pt: {
    ...
    accommodations: {
      ...
      subtitle: 'Deslize para descobrir as nossas 36 propriedades em Sesimbra',
      badge: 'Alojamento Sesimbra',
      featured: 'Destaque',
      prev: 'Casas anteriores',
      next: 'Casas seguintes',
      guests: 'pessoas',
      bedrooms: 'quartos',
      ...
      items: [
        ...
        { id: 3, subtitle: 'Apartamento no Centro da Vila a 2 min da Praia' },
        { id: 4, subtitle: 'T1 no 13º andar com vista para a baía e a Praia da Califórnia' },
      ],
    },
    services: {
    ...
    activities: {
      ...
      mapUnavailableReferrerError:
        'A chave da API não autoriza este URL. No Google Cloud Console, adicione o seu localhost (ex.: http://localhost:3001/*) às restrições de HTTP referrers da chave.',
      categories: {
    ...
    about: {
      ...
      stats: {
        ...
        stat2: { value: '+1000', label: 'Hóspedes recebidos', counterType: 'plus' as const, counterValue: 1000 },
    ...
    testimonials: {
      ...
      subtitle: 'Testemunhos de hóspedes',
  ...
  en: {
    ...
    accommodations: {
      ...
      subtitle: 'Swipe to discover our 36 properties in Sesimbra',
      ...
      items: [
        ...
        { id: 3, subtitle: 'Apartment in the village center, 2 min from the beach' },
        { id: 4, subtitle: 'T1 on the 13th floor with bay and California Beach views' },
      ],
    },
    services: {
      title: 'Our Services',
    ...
    activities: {
      ...
      description: 'At DolceStay we seek to provide our guests with dream holidays, authentic and personalized. To this end, we present various activities with restaurants, bars and companies that explore tourism in Sesimbra.',
      ...
      mapUnavailableReferrerError:
        'The API key does not allow this URL. In Google Cloud Console, add your localhost (e.g. http://localhost:3001/*) to the key’s HTTP referrer restrictions.',
      categories: {
    ...
    about: {
      ...
      stats: {
        ...
        stat2: { value: '+1000', label: 'Guests hosted', counterType: 'plus' as const, counterValue: 1000 },
    ...
    testimonials: {
      ...
      subtitle: 'Testimonials from guests',
  ...
  fr: {
    ...
    accommodations: {
      ...
      subtitle: 'Faites glisser pour découvrir nos 36 propriétés à Sesimbra',
      badge: 'Hébergement Sesimbra',
      featured: 'En Vedette',
      prev: 'Logements précédents',
      next: 'Logements suivants',
      guests: 'personnes',
      bedrooms: 'chambres',
      ...
      items: [
        ...
        { id: 3, subtitle: 'Appartement au centre du village, à 2 min de la plage' },
        { id: 4, subtitle: 'T1 au 13e étage avec vue sur la baie et la plage de California' },
      ],
    },
    services: {
      title: 'Nos Services',
    ...
    activities: {
      ...
      description: 'Chez DolceStay, nous cherchons à offrir à nos clients des vacances de rêve, authentiques et personnalisées. À cette fin, nous présentons diverses activités avec des restaurants, bars et entreprises qui explorent le tourisme à Sesimbra.',
      ...
      mapUnavailableReferrerError:
        'La clé API n’autorise pas cette URL. Dans Google Cloud Console, ajoutez votre localhost (ex. http://localhost:3001/*) aux restrictions de référents HTTP de la clé.',
      categories: {
    ...
    about: {
      ...
      stats: {
        ...
        stat2: { value: '+1000', label: 'Clients accueillis', counterType: 'plus' as const, counterValue: 1000 },
  ...
  es: {
    ...
    accommodations: {
      ...
      subtitle: 'Deslice para descubrir nuestras 36 propiedades en Sesimbra',
      badge: 'Alojamiento Sesimbra',
      featured: 'Destacado',
      prev: 'Alojamientos anteriores',
      next: 'Alojamientos siguientes',
      guests: 'personas',
      ...
      items: [
        ...
        { id: 3, subtitle: 'Apartamento en el centro del pueblo, a 2 min de la playa' },
        { id: 4, subtitle: 'T1 en el 13º piso con vista a la bahía y la playa California' },
      ],
    },
    services: {
    ...
    activities: {
      ...
      description: 'En DolceStay buscamos proporcionar a nuestros huéspedes unas vacaciones de ensueño, auténticas y personalizadas. Con este fin, presentamos diversas actividades con restaurantes, bares y empresas que exploran el turismo en Sesimbra.',
      ...
      mapUnavailableReferrerError:
        'La clave de API no autoriza esta URL. En Google Cloud Console, añada su localhost (p. ej. http://localhost:3001/*) a las restricciones de referentes HTTP de la clave.',
      categories: {
    ...
    about: {
      ...
      stats: {
        ...
        stat2: { value: '+1000', label: 'Huéspedes recibidos', counterType: 'plus' as const, counterValue: 1000 },
    ...
    testimonials: {
      ...
      subtitle: 'Testimonios de huéspedes',
  ...
  de: {
    ...
    accommodations: {
      ...
      subtitle: 'Wischen Sie, um unsere 36 Unterkünfte in Sesimbra zu entdecken',
      badge: 'Unterkunft Sesimbra',
      featured: 'Empfohlen',
      prev: 'Vorherige Unterkünfte',
      next: 'Nächste Unterkünfte',
      guests: 'Personen',
      bedrooms: 'Zimmer',
      ...
      items: [
        ...
        { id: 3, subtitle: 'Apartment im Ortszentrum, 2 Min. vom Strand' },
        { id: 4, subtitle: 'T1 im 13. Stock mit Blick auf die Bucht und den California-Strand' },
      ],
    },
    services: {
    ...
    activities: {
      ...
      description: 'Bei DolceStay möchten wir unseren Gästen Traumurlaube bieten, authentisch und personalisiert. Dazu präsentieren wir verschiedene Aktivitäten mit Restaurants, Bars und Unternehmen, die den Tourismus in Sesimbra erkunden.',
      ...
      mapUnavailableReferrerError:
        'Der API-Schlüssel erlaubt diese URL nicht. Fügen Sie in der Google Cloud Console Ihr localhost (z. B. http://localhost:3001/*) zu den HTTP-Referrer-Beschränkungen des Schlüssels hinzu.',
      categories: {
    ...
    about: {
      ...
      stats: {
        ...
        stat2: { value: '+1000', label: 'Gäste beherbergt', counterType: 'plus' as const, counterValue: 1000 },
    ...
    testimonials: {
      ...
      subtitle: 'Bewertungen von Gästen',
