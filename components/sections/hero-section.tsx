      ...
      <div className="relative z-10 container mx-auto px-4 py-20 pt-28 lg:pt-32">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-white/97 backdrop-blur-lg rounded-3xl p-8 md:p-12 lg:p-14 shadow-2xl border border-white/50">
            ...
            <div className="flex flex-wrap justify-center gap-4 lg:gap-8 pt-8 border-t border-[#E5E7EB]">
              <div className="flex items-center gap-3 px-4 py-2 bg-[#F8FAF8] rounded-full">
                <div className="w-10 h-10 bg-[#CFE8D2] rounded-full flex items-center justify-center">
                  <MapPin className="h-5 w-5 text-[#8DBE91]" />
                </div>
                <span className="text-sm font-semibold text-[#1F4E5F]">{t.hero.trustBadges.local}</span>
              </div>
              <div className="flex items-center gap-3 px-4 py-2 bg-[#F8FAF8] rounded-full">
                <div className="w-10 h-10 bg-[#CFE8D2] rounded-full flex items-center justify-center">
                  <Star className="h-5 w-5 text-[#8DBE91]" />
                </div>
                <span className="text-sm font-semibold text-[#1F4E5F]">{t.hero.trustBadges.personalized}</span>
              </div>
              <div className="flex items-center gap-3 px-4 py-2 bg-[#F8FAF8] rounded-full">
                <div className="w-10 h-10 bg-[#CFE8D2] rounded-full flex items-center justify-center">
                  <Users className="h-5 w-5 text-[#8DBE91]" />
                </div>
                <span className="text-sm font-semibold text-[#1F4E5F]">{t.hero.trustBadges.support}</span>
              </div>
            </div>
          </div>
        </div>
